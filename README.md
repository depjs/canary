...
| fixture | cache | lockfile | npm 12.0.1 | pnpm 11.18.0 | yarn 4.18.0 | dep 1.5.8 |
| --- | --- | --- | --- | --- | --- | --- |
| express | cold | no | 1.6s | 1.4s | 1.3s | ${\color{green}\textsf{0.6s}}$ |
|  | cold | yes | 1.0s | 1.0s | 1.0s | ${\color{green}\textsf{0.4s}}$ |
|  | warm | no | 0.9s | 0.7s | 0.8s | ${\color{green}\textsf{0.5s}}$ |
|  | warm | yes | 0.7s | 0.7s | 0.5s | ${\color{green}\textsf{0.4s}}$ |
| jest | cold | no | 8.2s | 3.8s | 4.2s | ${\color{green}\textsf{3.6s}}$ |
|  | cold | yes | 3.3s | ${\color{green}\textsf{1.7s}}$ | 2.8s | 2.3s |
|  | warm | no | 4.1s | 2.1s | ${\color{green}\textsf{2.0s}}$ | 3.6s |
|  | warm | yes | 2.4s | ${\color{green}\textsf{1.1s}}$ | 1.4s | 2.3s |
| next | cold | no | 9.5s | 3.4s | 85.7s | ${\color{green}\textsf{3.1s}}$ |
|  | cold | yes | 6.2s | 2.6s | 65.3s | ${\color{green}\textsf{1.9s}}$ |
|  | warm | no | 6.3s | ${\color{green}\textsf{1.9s}}$ | 5.9s | 3.0s |
|  | warm | yes | 5.2s | ${\color{green}\textsf{1.1s}}$ | 3.0s | 1.8s |
| react | cold | no | 1.2s | 0.9s | 1.3s | ${\color{green}\textsf{0.5s}}$ |
|  | cold | yes | 0.5s | 0.8s | 0.7s | ${\color{green}\textsf{0.2s}}$ |
|  | warm | no | 0.6s | 0.8s | 0.5s | ${\color{green}\textsf{0.4s}}$ |
|  | warm | yes | 0.4s | 0.6s | 0.4s | ${\color{green}\textsf{0.2s}}$ |
| vite | cold | no | 4.6s | 1.5s | 3.1s | ${\color{green}\textsf{1.0s}}$ |
|  | cold | yes | 1.1s | 1.3s | 1.2s | ${\color{green}\textsf{0.5s}}$ |
|  | warm | no | 1.5s | ${\color{green}\textsf{0.8s}}$ | ${\color{green}\textsf{0.8s}}$ | 0.9s |
|  | warm | yes | 0.7s | 0.7s | ${\color{green}\textsf{0.5s}}$ | ${\color{green}\textsf{0.5s}}$ |

Last run: [2026-07-29 14:52:21 UTC](https://github.com/depjs/canary/actions/runs/30461619849)
