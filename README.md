...
| fixture | cache | lockfile | npm 11.18.0 | pnpm 11.10.0 | yarn 4.17.0 | dep 1.5.7 |
| --- | --- | --- | --- | --- | --- | --- |
| express | cold | no | 1.6s | 1.0s | 1.3s | ${\color{green}\textsf{0.7s}}$ |
...
| jest | cold | no | 8.5s | 2.7s | 4.4s | ${\color{green}\textsf{2.2s}}$ |
|  | cold | yes | 3.3s | 1.6s | 2.7s | ${\color{green}\textsf{1.2s}}$ |
|  | warm | no | 3.9s | ${\color{green}\textsf{2.0s}}$ | 2.3s | 2.1s |
|  | warm | yes | 2.4s | ${\color{green}\textsf{1.0s}}$ | 1.4s | 1.2s |
| next | cold | no | 9.7s | 3.7s | 7.3s | ${\color{green}\textsf{3.0s}}$ |
|  | cold | yes | 6.8s | 2.6s | 5.7s | ${\color{green}\textsf{1.7s}}$ |
|  | warm | no | 7.1s | ${\color{green}\textsf{1.9s}}$ | 3.5s | 2.7s |
|  | warm | yes | 6.0s | ${\color{green}\textsf{1.0s}}$ | 3.1s | 1.7s |
...
| vite | cold | no | 4.2s | 1.4s | 3.1s | ${\color{green}\textsf{0.9s}}$ |
|  | cold | yes | 1.0s | 1.2s | 1.2s | ${\color{green}\textsf{0.4s}}$ |
|  | warm | no | 1.3s | ${\color{green}\textsf{0.7s}}$ | 0.8s | 0.9s |
|  | warm | yes | 0.6s | 0.6s | 0.5s | ${\color{green}\textsf{0.4s}}$ |

Last run: [2026-07-07 11:31:15 UTC](https://github.com/depjs/canary/actions/runs/28862649396)
