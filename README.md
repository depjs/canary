...
| fixture | cache | lockfile | npm 12.0.2 | pnpm 11.22.0 | yarn 4.18.0 | dep 1.5.8 |
| --- | --- | --- | --- | --- | --- | --- |
| express | cold | no | 1.9s | 1.0s | 1.4s | ${\color{green}\textsf{0.9s}}$ |
|  | cold | yes | 0.7s | 0.9s | 1.0s | ${\color{green}\textsf{0.3s}}$ |
|  | warm | no | 0.6s | 0.7s | 0.9s | ${\color{green}\textsf{0.5s}}$ |
|  | warm | yes | 0.4s | 0.7s | 0.5s | ${\color{green}\textsf{0.3s}}$ |
| jest | cold | no | 11.2s | 2.8s | 4.4s | ${\color{green}\textsf{1.9s}}$ |
|  | cold | yes | 3.4s | 1.8s | 2.8s | ${\color{green}\textsf{1.0s}}$ |
|  | warm | no | 4.1s | 2.1s | 2.1s | ${\color{green}\textsf{1.8s}}$ |
|  | warm | yes | 2.4s | 1.1s | 1.5s | ${\color{green}\textsf{1.0s}}$ |
| next | cold | no | 9.0s | 4.0s | 8.5s | ${\color{green}\textsf{2.3s}}$ |
|  | cold | yes | 6.2s | 2.8s | 6.5s | ${\color{green}\textsf{1.4s}}$ |
|  | warm | no | 6.6s | ${\color{green}\textsf{1.7s}}$ | 3.9s | 2.4s |
|  | warm | yes | 5.5s | ${\color{green}\textsf{0.9s}}$ | 3.5s | 1.3s |
| react | cold | no | 1.5s | 0.8s | 1.1s | ${\color{green}\textsf{0.6s}}$ |
...
| vite | cold | no | 6.2s | 1.4s | 3.3s | ${\color{green}\textsf{0.8s}}$ |
|  | cold | yes | 1.0s | 1.4s | 1.4s | ${\color{green}\textsf{0.4s}}$ |
|  | warm | no | 1.6s | ${\color{green}\textsf{0.8s}}$ | 0.9s | ${\color{green}\textsf{0.8s}}$ |
|  | warm | yes | 0.7s | 0.7s | 0.5s | ${\color{green}\textsf{0.4s}}$ |

Last run: [2026-08-15 18:54:14 UTC](https://github.com/depjs/canary/actions/runs/31902277123)
