...
| fixture | cache | lockfile | npm 12.0.1 | pnpm 11.15.0 | yarn 4.17.1 | dep 1.5.7 |
| --- | --- | --- | --- | --- | --- | --- |
| express | cold | no | 1.7s | 1.1s | 1.3s | ${\color{green}\textsf{0.6s}}$ |
|  | cold | yes | 0.9s | 1.0s | 1.0s | ${\color{green}\textsf{0.4s}}$ |
|  | warm | no | 0.9s | 0.8s | 0.7s | ${\color{green}\textsf{0.6s}}$ |
|  | warm | yes | 0.6s | 0.7s | 0.5s | ${\color{green}\textsf{0.4s}}$ |
| jest | cold | no | 9.0s | 2.6s | 3.1s | ${\color{green}\textsf{1.8s}}$ |
|  | cold | yes | 2.7s | 1.5s | 1.9s | ${\color{green}\textsf{1.0s}}$ |
|  | warm | no | 3.4s | 1.7s | ${\color{green}\textsf{1.5s}}$ | 1.7s |
|  | warm | yes | 1.8s | ${\color{green}\textsf{0.9s}}$ | ${\color{green}\textsf{0.9s}}$ | 1.0s |
| next | cold | no | 9.7s | 3.2s | 8.0s | ${\color{green}\textsf{2.1s}}$ |
|  | cold | yes | 6.9s | 2.5s | 6.1s | ${\color{green}\textsf{1.2s}}$ |
|  | warm | no | 7.2s | ${\color{green}\textsf{1.8s}}$ | 3.8s | 2.2s |
|  | warm | yes | 6.1s | ${\color{green}\textsf{1.0s}}$ | 3.4s | 1.2s |
| react | cold | no | 1.2s | 0.8s | 1.1s | ${\color{green}\textsf{0.5s}}$ |
...
| vite | cold | no | 4.0s | 1.5s | 3.3s | ${\color{green}\textsf{1.0s}}$ |
...
Last run: [2026-07-18 21:12:28 UTC](https://github.com/depjs/canary/actions/runs/29661073527)
