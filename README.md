...
| fixture | cache | lockfile | npm 12.0.1 | pnpm 11.12.0 | yarn 4.17.1 | dep 1.5.7 |
| --- | --- | --- | --- | --- | --- | --- |
| express | cold | no | 1.6s | 1.1s | 1.2s | ${\color{green}\textsf{0.6s}}$ |
...
| jest | cold | no | 8.2s | 2.7s | 3.4s | ${\color{green}\textsf{1.7s}}$ |
|  | cold | yes | 3.0s | 1.6s | 2.1s | ${\color{green}\textsf{1.0s}}$ |
|  | warm | no | 3.6s | 2.0s | ${\color{green}\textsf{1.6s}}$ | 1.8s |
|  | warm | yes | 2.1s | ${\color{green}\textsf{1.0s}}$ | 1.1s | ${\color{green}\textsf{1.0s}}$ |
| next | cold | no | 9.7s | 3.0s | 7.6s | ${\color{green}\textsf{2.2s}}$ |
|  | cold | yes | 6.9s | 2.0s | 5.4s | ${\color{green}\textsf{1.3s}}$ |
|  | warm | no | 7.3s | ${\color{green}\textsf{1.4s}}$ | 3.3s | 2.2s |
|  | warm | yes | 6.2s | ${\color{green}\textsf{0.8s}}$ | 2.9s | 1.3s |
| react | cold | no | 1.2s | 0.8s | 1.0s | ${\color{green}\textsf{0.6s}}$ |
|  | cold | yes | 0.5s | 0.8s | 0.6s | ${\color{green}\textsf{0.2s}}$ |
|  | warm | no | 0.6s | 0.6s | ${\color{green}\textsf{0.4s}}$ | 0.6s |
|  | warm | yes | 0.4s | 0.6s | 0.3s | ${\color{green}\textsf{0.2s}}$ |
| vite | cold | no | 3.9s | 1.4s | 3.2s | ${\color{green}\textsf{0.8s}}$ |
|  | cold | yes | 1.0s | 1.2s | 1.3s | ${\color{green}\textsf{0.4s}}$ |
|  | warm | no | 1.4s | ${\color{green}\textsf{0.8s}}$ | ${\color{green}\textsf{0.8s}}$ | ${\color{green}\textsf{0.8s}}$ |
|  | warm | yes | 0.7s | 0.7s | 0.5s | ${\color{green}\textsf{0.4s}}$ |

Last run: [2026-07-11 23:17:21 UTC](https://github.com/depjs/canary/actions/runs/29171798892)
