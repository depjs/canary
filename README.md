...
| fixture | cache | lockfile | npm 12.0.2 | pnpm 11.21.0 | yarn 4.18.0 | dep 1.5.8 |
| --- | --- | --- | --- | --- | --- | --- |
| express | cold | no | 1.7s | 1.0s | 1.2s | ${\color{green}\textsf{0.6s}}$ |
|  | cold | yes | 0.9s | 1.0s | 0.9s | ${\color{green}\textsf{0.4s}}$ |
|  | warm | no | 0.7s | 0.7s | 0.8s | ${\color{green}\textsf{0.6s}}$ |
|  | warm | yes | 0.5s | 0.7s | 0.5s | ${\color{green}\textsf{0.4s}}$ |
| jest | cold | no | 12.6s | 2.8s | 4.3s | ${\color{green}\textsf{2.1s}}$ |
|  | cold | yes | 3.3s | 1.8s | 2.6s | ${\color{green}\textsf{1.2s}}$ |
|  | warm | no | 4.0s | 2.1s | ${\color{green}\textsf{2.0s}}$ | ${\color{green}\textsf{2.0s}}$ |
|  | warm | yes | 2.4s | ${\color{green}\textsf{1.1s}}$ | 1.4s | 1.2s |
| next | cold | no | 9.9s | 3.5s | 8.2s | ${\color{green}\textsf{2.7s}}$ |
|  | cold | yes | 6.9s | 2.6s | 6.3s | ${\color{green}\textsf{1.7s}}$ |
|  | warm | no | 7.3s | ${\color{green}\textsf{1.7s}}$ | 3.8s | 2.6s |
|  | warm | yes | 6.2s | ${\color{green}\textsf{0.9s}}$ | 3.5s | 1.7s |
...
| vite | cold | no | 6.3s | 1.1s | 2.9s | ${\color{green}\textsf{0.9s}}$ |
|  | cold | yes | 0.9s | 1.1s | 1.2s | ${\color{green}\textsf{0.4s}}$ |
|  | warm | no | 1.6s | ${\color{green}\textsf{0.5s}}$ | 0.7s | 0.8s |
|  | warm | yes | 0.6s | ${\color{green}\textsf{0.4s}}$ | 0.5s | ${\color{green}\textsf{0.4s}}$ |

Last run: [2026-08-09 14:59:48 UTC](https://github.com/depjs/canary/actions/runs/31319784543)
