...
| fixture | cache | lockfile | npm 12.0.1 | pnpm 11.13.0 | yarn 4.17.1 | dep 1.5.7 |
| --- | --- | --- | --- | --- | --- | --- |
| express | cold | no | 1.5s | 1.0s | 1.3s | ${\color{green}\textsf{0.5s}}$ |
|  | cold | yes | 0.8s | 0.9s | 0.9s | ${\color{green}\textsf{0.4s}}$ |
|  | warm | no | 0.7s | 0.7s | 0.7s | ${\color{green}\textsf{0.5s}}$ |
|  | warm | yes | 0.5s | 0.6s | 0.5s | ${\color{green}\textsf{0.4s}}$ |
| jest | cold | no | 9.8s | 2.7s | 4.1s | ${\color{green}\textsf{1.8s}}$ |
|  | cold | yes | 2.9s | 1.6s | 2.7s | ${\color{green}\textsf{1.0s}}$ |
|  | warm | no | 3.6s | 1.9s | 2.0s | ${\color{green}\textsf{1.7s}}$ |
|  | warm | yes | 2.0s | ${\color{green}\textsf{1.0s}}$ | 1.4s | ${\color{green}\textsf{1.0s}}$ |
| next | cold | no | 8.4s | 3.3s | 6.7s | ${\color{green}\textsf{2.7s}}$ |
|  | cold | yes | 5.4s | 2.4s | 5.1s | ${\color{green}\textsf{1.6s}}$ |
|  | warm | no | 5.5s | ${\color{green}\textsf{1.7s}}$ | 3.1s | 2.6s |
|  | warm | yes | 4.6s | ${\color{green}\textsf{1.0s}}$ | 2.7s | 1.6s |
| react | cold | no | 1.2s | 0.7s | 1.3s | ${\color{green}\textsf{0.4s}}$ |
|  | cold | yes | 0.5s | 0.7s | 0.6s | ${\color{green}\textsf{0.2s}}$ |
|  | warm | no | 0.6s | 0.6s | 0.5s | ${\color{green}\textsf{0.4s}}$ |
|  | warm | yes | 0.4s | 0.6s | 0.3s | ${\color{green}\textsf{0.2s}}$ |
| vite | cold | no | 4.4s | 1.4s | 3.3s | ${\color{green}\textsf{0.9s}}$ |
|  | cold | yes | 0.9s | 1.2s | 1.2s | ${\color{green}\textsf{0.4s}}$ |
|  | warm | no | 1.3s | ${\color{green}\textsf{0.8s}}$ | ${\color{green}\textsf{0.8s}}$ | 1.0s |
|  | warm | yes | 0.7s | 0.7s | 0.5s | ${\color{green}\textsf{0.4s}}$ |

Last run: [2026-07-13 23:25:45 UTC](https://github.com/depjs/canary/actions/runs/29292877885)
