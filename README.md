...
| --- | --- | --- | --- | --- | --- | --- |
| express | cold | no | 1.6s | 1.0s | 1.2s | ${\color{green}\textsf{0.7s}}$ |
|  | cold | yes | 0.9s | 0.9s | 1.0s | ${\color{green}\textsf{0.5s}}$ |
|  | warm | no | 0.8s | ${\color{green}\textsf{0.7s}}$ | ${\color{green}\textsf{0.7s}}$ | ${\color{green}\textsf{0.7s}}$ |
|  | warm | yes | 0.5s | 0.6s | ${\color{green}\textsf{0.4s}}$ | 0.5s |
| jest | cold | no | 8.3s | 2.6s | 4.1s | ${\color{green}\textsf{2.1s}}$ |
|  | cold | yes | 3.4s | 1.7s | 2.6s | ${\color{green}\textsf{1.1s}}$ |
|  | warm | no | 3.9s | 2.0s | 2.1s | ${\color{green}\textsf{1.9s}}$ |
|  | warm | yes | 2.4s | ${\color{green}\textsf{1.0s}}$ | 1.4s | 1.1s |
| next | cold | no | 9.9s | 3.5s | 6.8s | ${\color{green}\textsf{2.6s}}$ |
|  | cold | yes | 7.0s | 2.6s | 5.2s | ${\color{green}\textsf{1.6s}}$ |
|  | warm | no | 7.3s | ${\color{green}\textsf{2.0s}}$ | 3.2s | 2.6s |
|  | warm | yes | 6.2s | ${\color{green}\textsf{1.0s}}$ | 2.8s | 1.6s |
| react | cold | no | 1.1s | 0.9s | 1.1s | ${\color{green}\textsf{0.5s}}$ |
|  | cold | yes | 0.5s | 0.7s | 0.6s | ${\color{green}\textsf{0.2s}}$ |
|  | warm | no | 0.6s | 0.8s | ${\color{green}\textsf{0.4s}}$ | ${\color{green}\textsf{0.4s}}$ |
|  | warm | yes | 0.4s | 0.6s | 0.3s | ${\color{green}\textsf{0.2s}}$ |
| vite | cold | no | 3.8s | 1.4s | 2.9s | ${\color{green}\textsf{0.7s}}$ |
|  | cold | yes | 0.9s | 1.2s | 1.2s | ${\color{green}\textsf{0.3s}}$ |
|  | warm | no | 1.3s | 0.8s | ${\color{green}\textsf{0.7s}}$ | ${\color{green}\textsf{0.7s}}$ |
|  | warm | yes | 0.6s | 0.7s | 0.5s | ${\color{green}\textsf{0.3s}}$ |

Last run: [2026-07-07 11:11:06 UTC](https://github.com/depjs/canary/actions/runs/28861561700)
